...
function slider_register_blocks()
{
    ...
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            ...
            'icon' => 'format-gallery',
            'render_template' => '/parts/wp_editor-blocks/slider/slider.php',
            'wp_enqueue_style' => get_template_directory_uri() . '/parts/wp_editor-blocks/slider/slider.css',
            'wp_enqueue_script' => get_template_directory_uri() . '/parts/wp_editor-blocks/slider/slider.js',
            'category' => 'formatting',
            'mode' => 'edit'
        ));
    }
